...
from crypto_wallet import generate_account, get_balance, send_transaction  # Step 3
...
st.sidebar.write(f"{balance} ETH")
...
wage = float(candidate_database[person][3] * hours)

# @TODO
# Write the `wage` calculation to the Streamlit sidebar
st.sidebar.write("Candidate's Wage:")
